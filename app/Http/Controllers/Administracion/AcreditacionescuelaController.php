...
class AcreditacionescuelaController extends Controller
{
    /** Sección Publicación */
    ...
    {
        $Datos = Resena::where('DES_TIPO', '=', 'ACRE')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.acreditacionescuela.index', compact('Datos'));
    }
    ...
    {
        return view('admin.acreditacionescuela.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.acreditacionescuela.editar', ['Registro' => $Datos]);
    }
