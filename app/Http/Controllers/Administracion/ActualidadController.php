...
class ActualidadController extends Controller
{
    ...
    {
        $Datos = Publicacion::where('DES_TIPO', '=', 'ACTU')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.actualidad.index', compact('Datos'));
    }
    ...
    {
        return view('admin.actualidad.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.actualidad.editar', ['Registro' => $Datos]);
    }
