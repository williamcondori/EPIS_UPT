...
class AutoevaluacionController extends Controller
{
    ...
    {
        $Datos = Resena::where('DES_TIPO', '=', 'AUTO')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.autoevaluacion.index', compact('Datos'));
    }
    ...
    {
        return view('admin.autoevaluacion.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.autoevaluacion.editar', ['Registro' => $Datos]);
    }
