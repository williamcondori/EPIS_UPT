...
class BrochureController extends Controller
{
    ...
    {
        $Datos = Documento::where('DES_TIPO', '=', 'BROC')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.brochure.index', compact('Datos'));
    }
    ...
    {
        return view('admin.brochure.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.brochure.editar', ['Registro' => $Datos]);
    }
