...
class CentroController extends Controller
{
    ...
    {
        $Datos = Publicacion::where('DES_TIPO', '=', 'CENT')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.centro.index', compact('Datos'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.centro.editar', ['Registro' => $Datos]);
    }
