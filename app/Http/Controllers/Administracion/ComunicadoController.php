...
class ComunicadoController extends Controller
{
    ...
    {
        $Datos = Publicacion::where('DES_TIPO', '=', 'COMU')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.comunicado.index', compact('Datos'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.comunicado.editar', ['Registro' => $Datos]);
    }
