...
class ConvenioController extends Controller
{
    ...
    {
        $Datos = Publicacion::where('DES_TIPO', '=', 'CONV')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.convenio.index', compact('Datos'));
    }
    ...
    {
        return view('admin.convenio.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.convenio.editar', ['Registro' => $Datos]);
    }
