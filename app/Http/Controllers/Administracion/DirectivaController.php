...
class DirectivaController extends Controller
{
    ...
    {
        $Datos = Documento::where('DES_TIPO', '=', 'DIRE')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.directiva.index', compact('Datos'));
    }
    ...
    {
        return view('admin.directiva.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.directiva.editar', ['Registro' => $Datos]);
    }
