...
class DocumentoestudianteController extends Controller
{
    ...
    {
        $Datos = Documento::where('DES_TIPO', '=', 'ESTU')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.documentoestudiante.index', compact('Datos'));
    }
    ...
    {
        return view('admin.documentoestudiante.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.documentoestudiante.editar', ['Registro' => $Datos]);
    }
