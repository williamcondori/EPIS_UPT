...
class EventoController extends Controller
{
    ...
    {
        $Datos = Publicacion::where('DES_TIPO', '=', 'EVEN')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.evento.index', compact('Datos'));
    }
    ...
    {
        return view('admin.evento.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.evento.editar', ['Registro' => $Datos]);
    }
