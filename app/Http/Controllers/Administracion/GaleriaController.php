...
class GaleriaController extends Controller
{
    ...
    {
        $Datos = Publicacion::where('DES_TIPO', '=', 'GALE')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.galeria.index', compact('Datos'));
    }
    ...
    {
        return view('admin.galeria.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.galeria.editar', ['Registro' => $Datos]);
    }
