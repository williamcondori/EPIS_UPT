...
class InfraestructuraController extends Controller
{
    ...
    {
        $Datos = Publicacion::where('DES_TIPO', '=', 'INFR')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.infraestructura.index', compact('Datos'));
    }
    ...
    {
        return view('admin.infraestructura.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.infraestructura.editar', ['Registro' => $Datos]);
    }
