...
class MisionController extends Controller
{
    ...
    {
        $Datos = Lista::where('DES_TIPO', '=', 'MISI')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.mision.index', compact('Datos'));
    }
    ...
    {
        return view('admin.mision.crear');
    }
    ...
    {
        $Datos = Lista::find($id);
        return view('admin.mision.editar', ['Registro' => $Datos]);
    }
