...
class NoticiaController extends Controller
{
    ...
    {
        $Datos = Publicacion::where('DES_TIPO', '=', 'NOTI')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.noticia.index', compact('Datos'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.noticia.editar', ['Registro' => $Datos]);
    }
