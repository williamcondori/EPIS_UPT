...
class ObjetivoController extends Controller
{
    ...
    {
        $Datos = Lista::where('DES_TIPO', '=', 'OBJE')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.objetivo.index', compact('Datos'));
    }
    ...
    {
        return view('admin.objetivo.crear');
    }
    ...
    {
        $Datos = Lista::find($id);
        return view('admin.objetivo.editar', ['Registro' => $Datos]);
    }
