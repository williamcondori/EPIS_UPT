...
class PalabraController extends Controller
{
    ...
    {
        $Datos = Resena::where('DES_TIPO', '=', 'PALA')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.palabra.index', compact('Datos'));
    }
    ...
    {
        return view('admin.palabra.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.palabra.editar', ['Registro' => $Datos]);
    }
