...
class ProyectoController extends Controller
{
    ...
    {
        $Datos = Publicacion::where('DES_TIPO', '=', 'PROY')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.proyecto.index', compact('Datos'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.proyecto.editar', ['Registro' => $Datos]);
    }
