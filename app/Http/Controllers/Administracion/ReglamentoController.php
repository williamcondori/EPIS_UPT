...
class ReglamentoController extends Controller
{
    ...
    {
        $Datos = Documento::where('DES_TIPO', '=', 'REGL')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.reglamento.index', compact('Datos'));
    }
    ...
    {
        return view('admin.reglamento.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.reglamento.editar', ['Registro' => $Datos]);
    }
