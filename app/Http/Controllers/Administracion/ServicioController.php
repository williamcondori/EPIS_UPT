...
class ServicioController extends Controller
{
    ...
    {
        $Datos = Publicacion::where('DES_TIPO', '=', 'SERV')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
    ...
    public function edit($id)
    {
        ...
        return view('admin.servicio.editar', ['Registro' => $Datos]);
    }
