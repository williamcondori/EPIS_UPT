...
class TramiteController extends Controller
{
    ...
    {
        $Datos = Documento::where('DES_TIPO', '=', 'TRAM')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.tramite.index', compact('Datos'));
    }
    ...
    {
        return view('admin.tramite.crear');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.tramite.editar', ['Registro' => $Datos]);
    }
