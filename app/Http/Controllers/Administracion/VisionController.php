...
class VisionController extends Controller
{
    ...
    {
        $Datos = Lista::where('DES_TIPO', '=', 'VISI')->orderBy('FEC_REGISTRO', 'DESC')->paginate(20);
        return view('admin.vision.index', compact('Datos'));
    }
    ...
    {
        return view('admin.vision.crear');
    }
    ...
    {
        $Datos = Lista::find($id);
        return view('admin.vision.editar', ['Registro' => $Datos]);
    }
