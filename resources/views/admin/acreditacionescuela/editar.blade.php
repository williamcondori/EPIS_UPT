...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.acreditacionescuela.index','Acreditación')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.acreditacionescuela.update', $Registro->COD_RESENA ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.acreditacionescuela.destroy', $Registro->COD_RESENA ], 'method' => 'DELETE']) !!}
