...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.autoevaluacion.index','Autoevaluación')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.autoevaluacion.update', $Registro->COD_RESENA ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.autoevaluacion.destroy', $Registro->COD_RESENA ], 'method' => 'DELETE']) !!}
