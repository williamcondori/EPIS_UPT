...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.brochure.index','Brochure virtual')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.brochure.update', $Registro->COD_DOCUMENTO ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.brochure.destroy', $Registro->COD_DOCUMENTO ], 'method' => 'DELETE']) !!}
