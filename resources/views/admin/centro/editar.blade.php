...
@section('content')
    <div>
        <h3>
            {!!link_to('gestion/informacion','Información')!!} /
            {!! link_to_route('gestion.centro.index','Centros de investigación')!!} / Crear
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.centro.update', $Registro->COD_PUBLICACION ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.centro.destroy', $Registro->COD_PUBLICACION ], 'method' => 'DELETE']) !!}
