...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.comunicado.index','Comunicados')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.comunicado.update', $Registro->COD_PUBLICACION ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.comunicado.destroy', $Registro->COD_PUBLICACION ], 'method' => 'DELETE']) !!}
