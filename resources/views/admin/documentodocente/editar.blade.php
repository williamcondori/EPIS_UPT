...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.documentodocente.index','Documentos para los docentes')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.documentodocente.update', $Registro->COD_DOCUMENTO ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.documentodocente.destroy', $Registro->COD_DOCUMENTO ], 'method' => 'DELETE']) !!}
