...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.documentoestudiante.index','Documentos para los estudiantes')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.documentoestudiante.update', $Registro->COD_DOCUMENTO ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.documentoestudiante.destroy', $Registro->COD_DOCUMENTO ], 'method' => 'DELETE']) !!}
