...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.evento.index','Eventos')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.evento.update', $Registro->COD_PUBLICACION ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.evento.destroy', $Registro->COD_PUBLICACION ], 'method' => 'DELETE']) !!}
