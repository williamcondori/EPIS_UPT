...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.galeria.index','Galería  de fotos')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.galeria.update', $Registro->COD_PUBLICACION ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">      
        {!! Form::open(['route' => ['gestion.galeria.destroy', $Registro->COD_PUBLICACION ], 'method' => 'DELETE']) !!}
