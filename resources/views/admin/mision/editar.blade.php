...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.mision.index','Misión')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.mision.update', $Registro->COD_LISTA ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.mision.destroy', $Registro->COD_LISTA ], 'method' => 'DELETE']) !!}
