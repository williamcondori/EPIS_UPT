...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.objetivo.index','Objetivos')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.objetivo.update', $Registro->COD_LISTA ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.objetivo.destroy', $Registro->COD_LISTA ], 'method' => 'DELETE']) !!}
