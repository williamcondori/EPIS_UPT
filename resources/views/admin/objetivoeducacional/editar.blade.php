...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.objetivoeducacional.index','Objetivos educacionales')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.objetivoeducacional.update', $Registro->COD_LISTA ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.objetivoeducacional.destroy', $Registro->COD_LISTA ], 'method' => 'DELETE']) !!}
