...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.presentacion.index','Presentación')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.presentacion.update', $Registro->COD_RESENA ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.presentacion.destroy', $Registro->COD_RESENA ], 'method' => 'DELETE']) !!}
