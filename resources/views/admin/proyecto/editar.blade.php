...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.proyecto.index','Proyectos')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.proyecto.update', $Registro->COD_PUBLICACION ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.proyecto.destroy', $Registro->COD_PUBLICACION ], 'method' => 'DELETE']) !!}
