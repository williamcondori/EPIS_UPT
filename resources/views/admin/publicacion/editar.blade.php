...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.publicacion.index','Publicaciones')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.publicacion.update', $Registro->COD_PUBLICACION ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.publicacion.destroy', $Registro->COD_PUBLICACION ], 'method' => 'DELETE']) !!}
