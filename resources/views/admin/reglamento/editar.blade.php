...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.reglamento.index','Reglamentos')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.reglamento.update', $Registro->COD_DOCUMENTO ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.reglamento.destroy', $Registro->COD_DOCUMENTO ], 'method' => 'DELETE']) !!}
