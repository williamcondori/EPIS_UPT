...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.servicio.index','Servicios')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.servicio.update', $Registro->COD_PUBLICACION ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.servicio.destroy', $Registro->COD_PUBLICACION ], 'method' => 'DELETE']) !!}
