...
@section('content')
    <div>
        <h3>
            ...
            {!! link_to_route('gestion.tramite.index','Trámites')!!} / Editar
        </h3>
    </div>
    <br>
    {!! Form::model($Registro, ['route' => ['gestion.tramite.update', $Registro->COD_DOCUMENTO ], 'method' => 'PUT', 'files' => true]) !!}
    ...
    {!! Form::close() !!}
    <div class="well wbSeccion">
        {!! Form::open(['route' => ['gestion.tramite.destroy', $Registro->COD_DOCUMENTO ], 'method' => 'DELETE']) !!}
